...
urlpatterns = [
    ...
    path('edit_forecast/<slug>/', views.EditForecast, name='edit_forecast'),
    path('delete_forecast/<slug>/', views.DeleteForecast, name='delete_forecast'),
    path('preview_forecast/<slug>/', views.PreviewForecast, name='preview_forecast'),
