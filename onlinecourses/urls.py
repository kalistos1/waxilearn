...
urlpatterns = [
    ...
    path('course/student/<int:pk>/start/', views.student_start_course, name = 'student_start_course'),
    path('course/student/lesson/<int:pk>/start', views.student_start_lesson, name = 'student_start_lesson'),
    ...
    path('course/buy/<int:pk>/', views.buy_course, name = 'buy_course'),
    ...
    path('course/lesson/addtext/', views.Add_Lesson_text, name='add_text'),
